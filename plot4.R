...
#make line graph 2
plot(mydata$DT, mydata$Voltage, typ = 'l', ylab = "Voltage", xlab = "datetime")
#make the line graph 3
...
#add graph 4
plot(mydata$DT, mydata$Global_reactive_power, typ = 'l', ylab = "Global_reactive_power", xlab = "datetime")
#close the device
dev.off()
